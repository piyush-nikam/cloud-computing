...
//cloud assignment 2
static int total_instruction_count = 0;
static int total_inc_instruction_count = 0;
static int total_call_instruction_count = 0;
static int total_ret_instruction_count = 0;
static int total_jmp_instruction_count = 0;
static int total_excep_instruction_count = 0;


static void get_instruction_count(void)
{
    total_instruction_count++;
    qemu_log("Total:: instruction count: %d, inc count: %d, call count: %d, return count: %d, jmp count: %d, excep count: %d \n", 
        total_instruction_count, 
        total_inc_instruction_count,
        total_call_instruction_count,
        total_ret_instruction_count,
        total_jmp_instruction_count,
        total_excep_instruction_count
        );
}

static void increment_instruction_inc_count(void)
{
    total_inc_instruction_count++;
    // qemu_log("increment_instruction_INC_count");
}

static void increment_instruction_call_count(void)
{
    total_call_instruction_count++;
    // qemu_log("increment_instruction_CALL_count");
}

static void increment_instruction_ret_count(void)
{
    total_ret_instruction_count++;
    // qemu_log("increment_instruction_RET_count");
}

static void increment_instruction_jmp_count(void)
{
    total_jmp_instruction_count++;
}

static void increment_instruction_excep_count(void)
{
    total_excep_instruction_count++;
}
...
{
    increment_instruction_excep_count();
    gen_update_cc_op(s);
    gen_jmp_im(s, cur_eip);
...
static target_ulong disas_insn(DisasContext *s, CPUState *cpu)
{
 ...
 reswitch:
    ...
    case 0x40 ... 0x47: /* inc Gv */
        increment_instruction_inc_count();
        qemu_log("increment_instruction_incgv_INC_count");
        ot = dflag;
    ...
    case 0xff: /* GRP5 */
        ...
        case 0: /* inc Ev */
            increment_instruction_inc_count();
            qemu_log("increment_instruction_incev_INC_count");
            if (mod != 3)
                opreg = OR_TMP0;
            else
                opreg = rm;
        ...
        case 1: /* dec Ev */
            ...
            break;
        case 2: /* call Ev */
            increment_instruction_call_count();
            qemu_log("increment_instruction_callev_CALL_count");
        ...
        case 3: /* lcall Ev */
            increment_instruction_call_count();
            qemu_log("increment_instruction_lcallev_CALL_count");
            gen_op_ld_v(s, ot, s->T1, s->A0);
        ...
        do_lcall:
            ...
            break;
        case 4: /* jmp Ev */
        increment_instruction_jmp_count();
            if (dflag == MO_16) {
                tcg_gen_ext16u_tl(s->T0, s->T0);
            }
            gen_op_jmp_v(s->T0);
    ...
    case 0xef:
        ...
        /* control */
    case 0xc2: /* ret im */
        increment_instruction_ret_count();
        qemu_log("increment_instruction_retim_RET_count");
    ...
    case 0xc3: /* ret */
        increment_instruction_ret_count();
        qemu_log("increment_instruction_ret_RET_count");
        ot = gen_pop_T0(s);
        gen_pop_update(s, ot);
        /* Note that gen_pop_T0 uses a zero-extending load.  */
        gen_op_jmp_v(s->T0);
    ...
    do_lret:
        increment_instruction_ret_count();
        qemu_log("increment_instruction_lretim_RET_count");
        if (s->pe && !s->vm86) {
            gen_update_cc_op(s);
            gen_jmp_im(s, pc_start - s->cs_base);
    ...
    case 0xcb: /* lret */
        increment_instruction_ret_count();
        qemu_log("increment_instruction_lret_RET_count");
        val = 0;
        goto do_lret;
    case 0xcf: /* iret */
        increment_instruction_ret_count();
        qemu_log("increment_instruction_iret_RET_count");
    ...
    case 0xe8: /* call im */
        {
            increment_instruction_call_count();
            qemu_log("increment_instruction_callim_CALL_count");
            if (dflag != MO_16) {
    ...
    case 0x9a: /* lcall im */
        {
            //cloud
            increment_instruction_call_count();
            qemu_log("increment_instruction_lcallim_CALL_count");
